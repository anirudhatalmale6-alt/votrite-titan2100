...
{
    class PartiesModel : ScreenModel
    {
        ...
        private void Initialize()
        {
            ...
            vars.Add("party_tip", session.CurrentLocale.PartyTip);
        ...
        public PartiesView GetView()
        {
            PartiesView v = null;

            foreach (IObserver obs in observers)
            {
                if (obs.GetType().ToString() == "VotRite.Views.PartiesView")
                {
                    v = (PartiesView)obs;
                    break;
                }
